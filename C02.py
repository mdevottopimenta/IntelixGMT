...
agente_focado = Agent(
    model=OpenRouterModel("openai/gpt-4o-mini"),
    system_prompt=(
        "Você analisa textos científicos e extrai as conclusões principais, como se fosse um analista junior em uma consultoria. "
        "Explique como se a pessoa não é do mundo científico."
        "Seja objetivo. Use linguagem técnica adequada. Use paragrafos. "
        "Não opine sobre o mérito da pesquisa — apenas extraia o que está no texto. "
